...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openServiceCalculator(assistanceType) {
        ...
        if (assistanceType === 'Hardware Issue') {
            parts = [
                { name: 'Motherboard', price: 3000 },
                { name: 'Mic', price: 500 },
                { name: 'Display', price: 2500 },
                { name: 'Camera', price: 1500 }
            ];
        } else if (assistanceType === 'Software Issue') {
            parts = [
                { name: 'OS Bug', price: 1000 },
                { name: 'Display', price: 1000 },
                { name: 'App Crash', price: 500 },
                { name: 'Performance', price: 1000 }
            ];
        } else if (assistanceType === 'Water Damage') {
            parts = [
                { name: 'Android ', price: 2500 },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    placeOrderBtn.addEventListener('click', function() {
        ...
        window.location.href = 'payment_form.html'; // Replace 'payment.html' with your actual payment page URL
    });
});
document.addEventListener('DOMContentLoaded', function() {
...
//form
function closeForm() {
    // Optionally, you can include form validation here before closing the form
    // Close the form
    document.getElementById("contact-form").style.display = "none";
    // Optionally, you can display a message or perform other actions after closing the form
    alert("Thank you for your submission!");
    // Ensure the form doesn't actually submit to the server
    return false;
}
 ...
 function initMap() {
    ...
    // Create a map object and display it in the specified container
